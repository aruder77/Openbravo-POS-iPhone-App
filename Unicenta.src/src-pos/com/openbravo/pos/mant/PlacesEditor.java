...
public class PlacesEditor extends JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("y");
        add(jLabel3);
        jLabel3.setBounds(210, 80, 10, 16);
        add(m_jX);
        m_jX.setBounds(140, 80, 50, 22);
        add(m_jY);
        m_jY.setBounds(230, 80, 50, 22);

        jLabel1.setText(AppLocal.getIntString("label.placefloor")); // NOI18N
        add(jLabel1);
        jLabel1.setBounds(20, 50, 90, 16);
        add(m_jFloor);
        m_jFloor.setBounds(110, 50, 180, 20);

        jLabel5.setText("x");
        add(jLabel5);
        jLabel5.setBounds(120, 80, 10, 16);

        jLabel6.setText(AppLocal.getIntString("label.placeposition")); // NOI18N
        add(jLabel6);
        jLabel6.setBounds(20, 80, 60, 16);

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 10));
        jLabel7.setText("<html>x & y is used to locate buttons which overlay your Table plan graphic set up in the Floor option");
        jLabel7.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        add(jLabel7);
        jLabel7.setBounds(20, 120, 360, 50);
