...
public class StockManagement extends JPanel implements JPanelView {
    ...
    private void initComponents() {
        ...
        jPanel3.add(m_jdate);
        m_jdate.setBounds(160, 10, 200, 22);
        ...
        jPanel3.add(jLabel8);
        jLabel8.setBounds(10, 70, 150, 16);
        ...
        m_jDelete.setBounds(430, 150, 54, 42);
        ...
        jPanel3.add(m_jDown);
        m_jDown.setBounds(490, 100, 54, 42);

        jPanel5.setLayout(new java.awt.BorderLayout());
        jPanel3.add(jPanel5);
        jPanel5.setBounds(10, 110, 410, 150);
        ...
        jEditAttributes.setBounds(490, 150, 56, 44);
        ...
        btnDownloadProducts.setBounds(450, 210, 77, 25);
