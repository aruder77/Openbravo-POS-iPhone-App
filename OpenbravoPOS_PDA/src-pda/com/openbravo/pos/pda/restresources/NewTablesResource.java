...
import com.openbravo.pos.pda.dao.DataLogicFloors;
...
public class NewTablesResource {

    @GET
    public Place[] getNewTables() {
    ...
    @GET
    @Path("/busyTables")
    public Place[] getNewBusyTables() {
    	Place[] places = getNewTables();
